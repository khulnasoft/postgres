...
variable "ansible_arguments" {
  type    = string
  default = "--skip-tags install-postgrest,install-pgbouncer,install-khulnasoft-internal"
}
...
build {
  ...
  provisioner "shell" {
    environment_vars = [
      ...
      "POSTGRES_KHULNASOFT_VERSION=${var.postgres-version}"
    ]

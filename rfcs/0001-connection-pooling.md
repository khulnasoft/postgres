...
We would like to explore connection pooling on Khulnasoft. This RFC is intended to decide:
...
- Security
- Not directly relevant to the "khulnasoft" stack, so it's additional non-core support

# Alternatives
[alternatives]: #alternatives

1. Since we already offer [PostgREST](https://github.com/postgrest/postgrest) and [postgres-meta](https://github.com/khulnasoft/pg-api), this isn't entirely necessary for the Khulnasoft stack. Bundling this is only beneficial for connecting external tools. 
